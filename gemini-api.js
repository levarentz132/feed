...
async function getGeminiPrompt(language, topic) {
  ...
  const prompt = `Buat pembuka percakapan dalam bahasa ${language} tentang topik: ${topic}. langsung mulai percakapan dengan pesan yang relevan. berikan pesan yang sangat singkat.`;
